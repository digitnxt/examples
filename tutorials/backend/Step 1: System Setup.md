...
To setup the DIGIT development environment the following tools are required for development:
   ...
   * **Install OpenAPI generator** - To install OpenAPI generator locally, follow the following links -
